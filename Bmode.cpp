...
int main(){
    ...
    for (int i = 1; i < parameters->getNumScanline(); i++)
    {
        ...
        currentScanline = currentScanline->next; //Move from current spot to next spot of the list
        currentScanline->next = NULL; //Continue till 'numScanline' is reached, the null
    }
